...
const Investments = () => {
  ...
  const investmentList: Array<Transaction> = transactionList.filtered("type == 'investment'");
    ...
    <SafeAreaProvider>
      <SafeAreaView className="flex-1">
        <FlatList
          ...
          ListHeaderComponent={<TransactionHeader title="Investments" searchText={searchText} setSearchText={setSearchText}/>}
          renderItem={({item}) => (
            <TransactionCard 
              type={item.type} 
              amount={item.amount} 

    ...
    <SafeAreaProvider>
      <SafeAreaView className="flex flex-1">
        ...
        <ScrollView showsVerticalScrollIndicator={false}
          className="flex flex-grow bg-background-primary"
        ...
        >
          <View className="flex flex-col justify-center items-center gap-3 p-4 w-full bg-background-secondary rounded-xl">
            ...
            <View className="flex flex-row gap-4 w-full">
              <Pressable 
                className="p-3 rounded-xl bg-background-primary" 
              ...
              />}
              <Pressable 
                className="flex flex-row justify-center items-center p-3 ms-auto rounded-xl bg-background-primary"
            ...
            {transactionFrequency !== "never" && <>
              ...
              {transactionEndRepeat === "on_date" && <View className="flex flex-row items-center w-full p-3 rounded-xl bg-background-primary">
